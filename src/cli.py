...
@click.option('--remove-punct/--no-remove-punct', is_flag=True, default=True)
@click.option('--remove-emails/--no-remove-emails', is_flag=True, default=True)
@click.option('--remove-numbers/--no-remove-numbers', is_flag=True, default=False)
@click.option('--remove-stop/--no-remove-stop', is_flag=True, default=True)
